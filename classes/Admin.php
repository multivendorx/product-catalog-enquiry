...
class Admin {
    ...
    public function catalog_admin_enqueue_scripts() {
        ...
        $tabs_names =[ 'store_display', 'catalog', 'enquiry_general', 'enquiry_multiple_cart', 'enquiry_out_of_stock', 'enquiry_button_management', 'enquiry_exclusion', 'enquiry_form_customization' ];
