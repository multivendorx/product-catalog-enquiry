...
export default {
    ...
    priority: 30,
    name: __("Custom Inquiry Form Builder", "woocommerce-catalog-enquiry"),
    desc: __("Design a personalized inquiry form with built-in form builder. ", "woocommerce-catalog-enquiry"),
    icon: 'font-settings',
